...
![initial boot screen](../images/infrastructure/instal_proxmox/initial_setup/1.png)
...
![harddisk selection](../images/infrastructure/instal_proxmox/initial_setup/2.png)
Hit next, and you'll be prompted to enter your country, and select a time zone and keyboard layout.
![keyboard layout](../images/infrastructure/instal_proxmox/initial_setup/3.png)
...
![password](../images/infrastructure/instal_proxmox/initial_setup/4.png)
...
![network](../images/infrastructure/instal_proxmox/initial_setup/5.png)
...
![summary](../images/infrastructure/instal_proxmox/initial_setup/6.png)
...
![installation successful](../images/infrastructure/instal_proxmox/initial_setup/7.png)
